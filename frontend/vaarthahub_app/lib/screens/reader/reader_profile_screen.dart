...
class _ReaderProfileScreenState extends State<ReaderProfileScreen> {
  ...
  Future<void> fetchReaderProfile() async {
    try {
      // String interpolation error fixed here
      final url = Uri.parse("${ApiConstants.baseUrl}/Reader/GetReaderProfile/${widget.readerCode}");
  ...
  Widget build(BuildContext context) {
    ...
    final String displayAddress = readerData?['address'] ?? "Address Not Updated";
    final String displayPanchayat = readerData?['panchayatName'] ?? "Panchayat Info";
    final String? displayWard = readerData?['wardNumber']?.toString();
    final String? profileImgBase64 = readerData?['profileImage']; // Base64 image from API
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(displayPhone, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    _buildBadge("Gold Badge", color: const Color(0xFFF9C55E), textColor: Colors.black),
                                  ],
                                )
                              ],
                            ),
                            
                            /// AVATAR LOGIC (API Image or Local Asset)
                          Container(
                      ...
                      _buildAddressCard(displayAddress, displayPanchayat, displayWard),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildSettingCard(
                              ...
                              title: 'Subscriptions',
                              subtitle: 'Newspapers / Magazines / Kid\'s Magazines',
                            ),
                            const SizedBox(height: 12),
                            ...
                            _buildSettingCard(
                              ...
                              title: 'Publications',
                              subtitle: 'Track status of Obituaries, Greetings and Articles',
                            ),
                            const SizedBox(height: 12),

                            InkWell(
                              onTap: () {
                                final partnerCode = readerData?['addedByPartnerCode'] ?? '';
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                              ...
                              child: _buildSettingCard(
                                ...
                                subtitle: 'Rate your delivery partner & service',
                              ),
                            ),
                            ...
                            InkWell(
                              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ReaderPersonalInformation())),
                              child: _buildSettingCard(
                            ...
                            InkWell(
                              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const LanguagePreferenceScreen())),
                              child: _buildSettingCard(
                            ...
                            const Center(child: Text("VaarthaHub Made with ❤️ in Kerala", style: TextStyle(fontSize: 12, color: Colors.grey))),
  ...
  Widget _buildAddressCard(String address, String panchayat, String? ward) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.place_outlined, color: Colors.red, size: 20),
          ),
              ...
              children: [
                const Row(
                  ...
                  children: [
                    ...
                    Text("Edit Address", style: TextStyle(color: Colors.red, fontSize: 12, fontWeight: FontWeight.w600, decoration: TextDecoration.underline)),
                  ],
                ),
                const SizedBox(height: 4),
                Text("$address\n$panchayat ${ward != null && ward.isNotEmpty ? '(Ward: $ward)' : ''}", 
