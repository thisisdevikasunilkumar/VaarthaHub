class DeliveryPartnerSalaryModel {
  ...
  factory DeliveryPartnerSalaryModel.fromJson(Map<String, dynamic> json) {
    return DeliveryPartnerSalaryModel(
      ...
      basicSalaryLastUpdate: json['basicSalaryLastUpdate'] != null ? DateTime.parse(json['basicSalaryLastUpdate']) : null,
      incentiveLastUpdate: json['incentiveLastUpdate'] != null ? DateTime.parse(json['incentiveLastUpdate']) : null,
