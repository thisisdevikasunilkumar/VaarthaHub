...
import '../admin/manage_calendar_dairy_screen.dart';
import '../admin/deliverypartner_performance.dart';
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: _buildSettingCard(
                              ...
                              subtitle: 'Add or update catalog items',
                            ),
                          ),
                          const SizedBox(height: 12),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const ManageCalendarDairyScreen(),
                                ),
                              );
                            },
                            child: _buildSettingCard(
                              ...
                              title: 'Calendar & Diary Management',
                              subtitle:
                                  'Add or update year-end calendars and diaries',
                            ),
                          ),
                          ...
                          InkWell(
                            ...
                            child: _buildSettingCard(
                              ...
                              subtitle: 'Manage recycling & waste collection',
                            ),
                          ),
                          const SizedBox(height: 12),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const DeliveryPartnerPerformance(),
                                ),
                              );
                            },
                            child: _buildSettingCard(
                              ...
                              subtitle: 'Check Delivery partners performance',
                            ),
                          ),
                          const SizedBox(height: 12),
