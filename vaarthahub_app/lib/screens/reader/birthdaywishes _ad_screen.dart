...
class BirthdayWishesAdScreen extends StatefulWidget {
  const BirthdayWishesAdScreen({super.key});

  @override
  State<BirthdayWishesAdScreen> createState() => _BirthdayWishesAdScreenState();
}

class _BirthdayWishesAdScreenState extends State<BirthdayWishesAdScreen> {
  ...
  Future<void> fetchCardTypes() async {
    try {
      const String category = 'Birthday Wishes';
      final url = Uri.parse(
