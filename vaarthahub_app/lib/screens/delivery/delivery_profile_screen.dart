...
import '../delivery/subscribed_readers_screen.dart';
...
class _DeliveryPartnerProfileState extends State<DeliveryPartnerProfile> {
  ...
  Future<void> fetchPartnerProfile() async {
    try {
      final url = Uri.parse(
        "${ApiConstants.baseUrl}/DeliveryPartner/GetDeliveryPartnerProfile/${widget.partnerCode}",
      );
  ...
  Widget build(BuildContext context) {
    ...
    final String displayRating =
        partnerData?['averageRating']?.toString() ?? '0.0';
    final String displayName = partnerData?['fullName'] ?? 'Partner Name';
    final String displayPhone =
        partnerData?['phoneNumber'] ?? '+91 00000 00000';
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  _buildBadge(
                                    "Partner Code: $displayPartnerCode",
                                  ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              final pId = partnerData?['deliveryPartnerId'];
                              if (pId != null) {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        SubscribedReadersScreen(partnerId: pId),
                                  ),
                                );
                              }
                            },
                            child: _buildSettingCard(
                              ...
                              subtitle: 'View your readers and subscriptions',
                            ),
                          ),
                          const SizedBox(height: 12),
                          ...
                          InkWell(
                            ...
                            child: _buildSettingCard(
                              ...
                              subtitle:
                                  'Check your service quality and reviews',
                            ),
                          ),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const DeliveryPartnerPersonalInfo(),
                                ),
                              ).then((_) {
                                fetchPartnerProfile();
                              });
